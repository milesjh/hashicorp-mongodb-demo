...
data "hcp_packer_artifact" "ubuntu_mantic_hashi_x86" {
...
resource "aws_launch_template" "nomad_client_x86_launch_template" {
  name_prefix   = "lt-"
  image_id      = data.hcp_packer_artifact.ubuntu_mantic_hashi_x86.external_identifier
    ...
    templatefile("${path.module}/scripts/nomad-node.tpl",
      {
        ...
        nomad_node_pool    = "x86",
        nomad_servers      = "provider=aws tag_key=nomad tag_value=server",
...
resource "aws_launch_template" "nomad_client_arm_launch_template" {
  name_prefix   = "lt-"
  image_id      = data.hcp_packer_artifact.ubuntu_mantic_hashi_arm.external_identifier
